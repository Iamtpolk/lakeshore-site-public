(function () {
  ...
  var css = `
    ...
    body.home .md-hero .title-text{display:flex!important;flex-direction:column!important;align-items:flex-start!important;gap:clamp(14px,1.3vw,22px)!important}
    body.home .md-hero .site-title{width:100%!important;max-width:none!important;margin:0!important;text-align:left!important}
    body.home .md-hero .site-title[aria-level="1"] h1{max-width:1120px!important;margin:0!important;font-size:clamp(46px,3.9vw,70px)!important;line-height:1.04!important;letter-spacing:-.025em!important;text-wrap:balance;text-shadow:0 3px 22px rgba(0,0,0,.58)}
    body.home .md-hero .site-title[aria-level="3"]{max-width:900px!important;font-size:clamp(17px,1.15vw,21px)!important;line-height:1.5!important;text-wrap:balance;text-shadow:0 2px 16px rgba(0,0,0,.62)}
    ...
    @media(max-width:900px){body.home .md-hero .media-content-v2{padding-inline:clamp(24px,6vw,52px)!important}body.home .md-hero .site-title[aria-level="1"] h1{font-size:clamp(42px,7vw,60px)!important;max-width:850px!important}body.home .md-hero .site-title[aria-level="3"]{max-width:720px!important;font-size:17px!important}}
    @media(max-width:720px){body.home .md-hero .banner,body.home .md-hero .banner.single{height:600px!important;min-height:600px!important;max-height:600px!important}body.home .md-hero .single-picture{background-position:center 58%!important;background-size:cover!important;transform:scale(calc(1.015 + var(--lst-hero-progress) * .02))}body.home .md-hero .media-content-v2{padding-inline:24px!important;transform:translate3d(0,calc(var(--lst-hero-progress) * -14px),0);opacity:calc(1 - var(--lst-hero-progress) * .22)}body.home .md-hero .title-text{gap:14px!important}body.home .md-hero .site-title[aria-level="1"] h1{font-size:clamp(38px,10vw,48px)!important;line-height:1.05!important;max-width:560px!important}body.home .md-hero .site-title[aria-level="3"]{max-width:520px!important;font-size:16px!important;line-height:1.45!important}}
