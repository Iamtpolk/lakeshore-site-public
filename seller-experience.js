(function () {
  ...
  var css = `
    ...
    body.sell .md-sell-banner .address-input{width:min(100%,740px)!important;height:auto!important;min-height:76px!important;margin:34px auto 0!important;padding:8px!important;box-sizing:border-box!important;align-items:stretch!important;border:1px solid rgba(255,255,255,.25)!important;border-radius:18px!important;background:rgba(248,247,242,.14)!important;box-shadow:0 24px 70px rgba(0,0,0,.28)!important;backdrop-filter:blur(18px) saturate(125%)!important;-webkit-backdrop-filter:blur(18px) saturate(125%)!important}
    ...
    body.sell .md-sell-banner .address-input .left-box{flex:1 1 auto!important;min-width:0!important}
    body.sell .md-sell-banner .address-input .right-box{flex:0 0 200px!important;width:200px!important;max-width:200px!important;margin-left:8px!important;box-sizing:border-box!important}
