(function () {
  ...
  var css = `
    ...
    .lst-team-card { position:relative;display:flex;flex-direction:column;min-width:0;overflow:hidden;border:1px solid rgba(185,144,82,.34);border-radius:24px;background:linear-gradient(155deg,rgba(73,16,19,.9),rgba(55,10,13,.88) 48%,rgba(29,7,9,.95));box-shadow:inset 0 1px 0 rgba(255,255,255,.12),inset 0 -1px 0 rgba(185,144,82,.1),0 24px 50px rgba(0,0,0,.34);backdrop-filter:blur(18px) saturate(105%);-webkit-backdrop-filter:blur(18px) saturate(105%);transition:transform .28s ease,border-color .28s ease,box-shadow .28s ease; }
