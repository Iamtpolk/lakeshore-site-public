(function () {
  ...
  var icons = {
    instagram: '<svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5"/><circle cx="12" cy="12" r="4.2"/><circle cx="17.5" cy="6.5" r="1" fill="currentColor" stroke="none"/></svg>',
  ...
  function card(member) {
    ...
    return '<article class="lst-team-card">' +
      ...
      '<div class="lst-team-card-body">' +
        ...
        '<a class="lst-team-connect" href="' + escapeHtml(member.connect) + '" target="_blank" rel="noopener noreferrer">Connect <span aria-hidden="true">â†’</span></a></div>' +
      '</div>' +
    '</article>';
  }
