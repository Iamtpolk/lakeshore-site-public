(function () {
  ...
  function build(main, listings, footer) {
    ...
    function personalizeChat() {
      document.querySelectorAll('#chat-app img[alt="avatar"], #chat-app img[alt="Chelsea Porter"]').forEach(function (image) {
