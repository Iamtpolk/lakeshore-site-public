...
(function () {
  ...
  function build(main, listings, footer) {
    ...
    contact.innerHTML = `<div class="cp-shell cp-contact-card"><div class="cp-contact-copy"><span class="cp-kicker">Request a consultation</span><h2 class="cp-serif">Thinking about making a move?</h2><p>Tell Chelsea what you are planning. She will follow up personally with clear next stepsâ€”no pressure and no generic sales pitch.</p></div><div class="cp-contact-actions"><p>Ready when you are. Start with a quick conversation or visit the consultation page.</p><a class="cp-button" href="/contact">Request a consultation â†’</a><div class="cp-socials"><a href="https://www.instagram.com/cporter_realtor" aria-label="Chelsea on Instagram"><img src="https://cdn.simpleicons.org/instagram/E4405F" alt=""></a><a href="https://www.facebook.com/share/19TkPweKzQ/?mibextid=wwXIfr" aria-label="Chelsea on Facebook"><img src="https://cdn.simpleicons.org/facebook/1877F2" alt=""></a></div></div></div>`;
