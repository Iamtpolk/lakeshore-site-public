(function () {
  ...
  style.textContent = `
    ...
    body.home .page-content>#lst-reviews-root{order:4!important}
    body.home .page-content>#lst-areas-root{order:5!important}
    body.home .page-content>.md-house{order:6!important}
    body.home .page-content>#lst-team-root{order:7!important}
